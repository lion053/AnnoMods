...
*For all the others: In addition to some new content, the way how the buildings and buffs work, has changed.*
...
- QoL: You can change the visual appearance of higher stages of the MTD to the visual appearance of lower stages (Ctrl V) (no more obligation to build a huge skyscraper)
